...
//    /// </summary>
//    internal static TimeSpan RiskRange //stage 4-5
//    {
...
//        AssignmentManager.PeriodicAssignmentUpdates(oldClock, newClock); //stage 4
//        //etc ...
    ...
    private static void clockRunner()
    {
        while (!s_stop)
        {
            ...
            if (_simulateTask is null || _simulateTask.IsCompleted)//stage 7
                _simulateTask = Task.Run(() => VolunteerManager.SimulateAssigningCallsToVolunteers());
